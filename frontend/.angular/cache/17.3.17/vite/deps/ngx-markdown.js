...
var MarkdownService = class _MarkdownService {
  ...
  sanitizeHtml(html) {
    return __async(this, null, function* () {
      if (isSanitizeFunction(this.sanitize)) {
        return this.sanitize(yield html);
      }
  ...
  static {
    this.ɵfac = function MarkdownService_Factory(t) {
      return new (t || _MarkdownService)(ɵɵinject(CLIPBOARD_OPTIONS, 8), ɵɵinject(MARKED_EXTENSIONS, 8), ɵɵinject(MARKED_OPTIONS, 8), ɵɵinject(MERMAID_OPTIONS, 8), ɵɵinject(PLATFORM_ID), ɵɵinject(SANITIZE), ɵɵinject(HttpClient, 8), ɵɵinject(DomSanitizer));
    };
  }
  static {
